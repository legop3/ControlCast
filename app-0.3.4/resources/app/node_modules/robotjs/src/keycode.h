...
enum _MMKeyCode {
	...
	K_LEFTCONTROL = XK_Control_L,
	K_RIGHTCONTROL = XK_Control_R,
	K_SHIFT = XK_Shift_L,
	K_LEFTSHIFT = XK_Shift_L,
...
enum _MMKeyCode {
	...
	K_LEFTCONTROL = VK_LCONTROL,
	K_RIGHTCONTROL = VK_RCONTROL,
	K_SHIFT = VK_SHIFT,
	K_LEFTSHIFT = VK_LSHIFT,
